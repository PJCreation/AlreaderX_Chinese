...
.method public static j(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    .locals 22
    ...
    .line 6
    invoke-static {v4}, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->j(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;
...
.method public n()Ljava/lang/Object;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->p:Landroid/media/session/PlaybackState;
    ...
    .line 3
    iget v3, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->e:I

    iget-wide v4, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->f:J

    iget v6, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->h:F

    iget-wide v7, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->l:J
    ...
    .line 8
    invoke-virtual {v2}, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->k()Ljava/lang/Object;
    ...
    .line 12
    iget-object v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->o:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->p:Landroid/media/session/PlaybackState;
