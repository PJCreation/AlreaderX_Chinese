...
.method private u(Landroid/support/v4/media/MediaMetadataCompat;)V
    .locals 3
    ...
    .line 4
    :try_start_1
    invoke-interface {v2, p1}, Landroid/support/v4/media/session/a;->k(Landroid/support/v4/media/MediaMetadataCompat;)V
    :try_end_1
...
.method private v()V
    ...
    .line 4
    :try_start_1
    invoke-interface {v2}, Landroid/support/v4/media/session/a;->i()V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private w(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    .locals 3
    ...
    .line 4
    :try_start_1
    invoke-interface {v2, p1}, Landroid/support/v4/media/session/a;->b0(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method B()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/media/session/MediaSessionCompat$j;->t(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/media/session/MediaSessionCompat$j;->k(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/media/session/MediaSessionCompat$j;->h(Landroid/support/v4/media/session/PlaybackStateCompat;)V
...
.method public a()V
    ...
    .line 4
    invoke-direct {p0}, Landroid/support/v4/media/session/MediaSessionCompat$j;->v()V

    const/4 v0, 0x0

    .line 5
    invoke-virtual {p0, v0, v0}, Landroid/support/v4/media/session/MediaSessionCompat$j;->i(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
...
.method public h(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 4
    invoke-direct {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$j;->w(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    invoke-virtual {p0, v1, v2}, Landroid/support/v4/media/session/MediaSessionCompat$j;->r(J)I
...
.method public k(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    .line 5
    invoke-direct {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$j;->u(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    .line 8
    :goto_0
    invoke-virtual {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$j;->o(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
...
.method public m()Landroidx/media/MediaSessionManager$RemoteUserInfo;
    .locals 2
    ...
    .line 2
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$j;->q:Landroidx/media/MediaSessionManager$RemoteUserInfo;
...
.method o(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
    .locals 6
...
.method s(IIILjava/lang/Object;Landroid/os/Bundle;)V
    .locals 2
    ...
    .line 7
    invoke-virtual {p0, p3}, Landroid/support/v4/media/session/MediaSessionCompat$j;->p(I)Ljava/lang/String;
...
.method t(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    .locals 0
...
.method x(Landroid/support/v4/media/session/ParcelableVolumeInfo;)V
    .locals 3
    ...
    .line 4
    :try_start_1
    invoke-interface {v2, p1}, Landroid/support/v4/media/session/a;->f0(Landroid/support/v4/media/session/ParcelableVolumeInfo;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method y(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$j;->q(I)I
