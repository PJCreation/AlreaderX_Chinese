...
.method public static i0()Landroid/support/v4/media/session/b;
    .locals 1
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 7
    :cond_1
    invoke-interface {p0, p1, v3}, Landroid/support/v4/media/session/b;->h(Landroid/support/v4/media/RatingCompat;Landroid/os/Bundle;)V
    ...
    .line 17
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/b;->d0(F)V
    ...
    .line 29
    :cond_3
    invoke-interface {p0, v0}, Landroid/support/v4/media/session/b;->n(Z)V
    ...
    .line 42
    :cond_4
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/b;->s(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    .line 48
    invoke-interface {p0, v3, p1}, Landroid/support/v4/media/session/b;->j(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    .line 57
    :cond_7
    invoke-interface {p0, v0}, Landroid/support/v4/media/session/b;->T(Z)V
    ...
    .line 64
    invoke-interface {p0}, Landroid/support/v4/media/session/b;->m()Z
    ...
    .line 104
    invoke-interface {p0}, Landroid/support/v4/media/session/b;->L()Ljava/lang/CharSequence;
    ...
    .line 110
    invoke-interface {p0}, Landroid/support/v4/media/session/b;->H()Ljava/util/List;
    ...
    .line 120
    invoke-interface {p0}, Landroid/support/v4/media/session/b;->c()Landroid/support/v4/media/MediaMetadataCompat;
    ...
    .line 160
    invoke-interface {p0, p1, p2}, Landroid/support/v4/media/session/b;->S(J)V
    ...
    .line 173
    :cond_14
    invoke-interface {p0, p1, v3}, Landroid/support/v4/media/session/b;->U(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 194
    invoke-interface {p0, p1, p4, p2}, Landroid/support/v4/media/session/b;->f(IILjava/lang/String;)V
    ...
    .line 197
    invoke-interface {p0}, Landroid/support/v4/media/session/b;->V()Landroid/support/v4/media/session/ParcelableVolumeInfo;
    ...
    .line 213
    invoke-interface {p0}, Landroid/support/v4/media/session/b;->l()Ljava/lang/String;
    ...
    invoke-static {p1}, Landroid/support/v4/media/session/a$a;->h0(Landroid/os/IBinder;)Landroid/support/v4/media/session/a;

    move-result-object p1

    .line 226
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/b;->P(Landroid/support/v4/media/session/a;)V
    ...
    .line 230
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/b;->g(Landroid/support/v4/media/session/a;)V
    ...
    .line 235
    :cond_18
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/b;->g0(Landroid/view/KeyEvent;)Z
    ...
    .line 244
    :cond_1a
    invoke-interface {p0, p1, p4, v3}, Landroid/support/v4/media/session/b;->G(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;)V
