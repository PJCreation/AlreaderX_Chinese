...
.field o:Landroid/support/v4/media/session/MediaSessionCompat$l;
    .annotation build Landroidx/annotation/GuardedBy;
        value = "mLock"
    .end annotation
.end field
...
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroidx/versionedparcelable/VersionedParcelable;Landroid/os/Bundle;)V
    ...
    .line 5
    invoke-virtual {p0, p1, p2, p4}, Landroid/support/v4/media/session/MediaSessionCompat$f;->n(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Landroid/media/session/MediaSession;
...
.method public e(Landroidx/media/MediaSessionManager$RemoteUserInfo;)V
    ...
    .line 2
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->p:Landroidx/media/MediaSessionManager$RemoteUserInfo;
...
.method public h(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 4
    iget-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->f:Landroid/os/RemoteCallbackList;
...
.method public k(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    .line 3
    :cond_0
    invoke-virtual {p1}, Landroid/support/v4/media/MediaMetadataCompat;->p()Ljava/lang/Object;
...
.method public m()Landroidx/media/MediaSessionManager$RemoteUserInfo;
    ...
    .line 2
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->p:Landroidx/media/MediaSessionManager$RemoteUserInfo;
