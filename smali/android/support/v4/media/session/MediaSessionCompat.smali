...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;Landroidx/versionedparcelable/VersionedParcelable;)V
    ...
    invoke-interface {p2, v6}, Landroid/support/v4/media/session/MediaSessionCompat$c;->l(Landroid/app/PendingIntent;)V
...
.method public f(Z)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->d(Z)V
...
.method public h(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
    ...
    invoke-interface {p1, p2, p2}, Landroid/support/v4/media/session/MediaSessionCompat$c;->i(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
    ...
    :goto_0
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$c;->i(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
...
.method public k(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->k(Landroid/support/v4/media/MediaMetadataCompat;)V
...
.method public l(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->h(Landroid/support/v4/media/session/PlaybackStateCompat;)V
