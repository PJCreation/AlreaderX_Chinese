...
.method constructor <init>(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    .line 2
    invoke-virtual {p1}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->n()Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroid/os/IBinder;

    invoke-static {p1}, Landroid/support/v4/media/session/b$a;->h0(Landroid/os/IBinder;)Landroid/support/v4/media/session/b;
...
.method public a()Landroid/app/PendingIntent;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/b;->v()Landroid/app/PendingIntent;
...
.method public b(Landroid/view/KeyEvent;)Z
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/b;->g0(Landroid/view/KeyEvent;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public c()Landroid/support/v4/media/MediaMetadataCompat;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/b;->c()Landroid/support/v4/media/MediaMetadataCompat;
