...
# direct methods
.method public constructor <init>(Lokhttp3/internal/connection/c;Lokio/v;J)V
    .locals 1
    ...
    .line 2
    invoke-direct {p0, p2}, Lokio/f;-><init>(Lokio/v;)V
    ...
    .line 4
    iput-boolean p1, p0, Lokhttp3/internal/connection/c$b;->h:Z
    ...
    .line 5
    invoke-virtual {p0, p1}, Lokhttp3/internal/connection/c$b;->e(Ljava/io/IOException;)Ljava/io/IOException;
...
.method public close()V
    ...
    .line 1
    iget-boolean v0, p0, Lokhttp3/internal/connection/c$b;->j:Z
    ...
    .line 2
    iput-boolean v0, p0, Lokhttp3/internal/connection/c$b;->j:Z
    ...
    .line 4
    invoke-virtual {p0, v0}, Lokhttp3/internal/connection/c$b;->e(Ljava/io/IOException;)Ljava/io/IOException;
    :try_end_0
...
.method public final e(Ljava/io/IOException;)Ljava/io/IOException;
    ...
    invoke-virtual {v0}, Lokhttp3/internal/connection/c;->i()Lokhttp3/t;
    ...
    invoke-virtual {v0, v1}, Lokhttp3/t;->w(Lokhttp3/f;)V

    .line 6
    :cond_1
    iget-object v2, p0, Lokhttp3/internal/connection/c$b;->k:Lokhttp3/internal/connection/c;

    iget-wide v3, p0, Lokhttp3/internal/connection/c$b;->g:J
...
.method public y(Lokio/b;J)J
    ...
    .line 2
    :try_start_0
    invoke-virtual {p0}, Lokio/f;->a()Lokio/v;
    ...
    .line 3
    iget-boolean p3, p0, Lokhttp3/internal/connection/c$b;->h:Z
    ...
    .line 4
    iput-boolean p3, p0, Lokhttp3/internal/connection/c$b;->h:Z

    .line 5
    iget-object p3, p0, Lokhttp3/internal/connection/c$b;->k:Lokhttp3/internal/connection/c;

    invoke-virtual {p3}, Lokhttp3/internal/connection/c;->i()Lokhttp3/t;
    ...
    invoke-virtual {p3, v0}, Lokhttp3/t;->w(Lokhttp3/f;)V
    ...
    .line 6
    invoke-virtual {p0, p3}, Lokhttp3/internal/connection/c$b;->e(Ljava/io/IOException;)Ljava/io/IOException;

    return-wide v0

    .line 7
    :cond_1
    iget-wide v2, p0, Lokhttp3/internal/connection/c$b;->g:J
    ...
    :cond_3
    :goto_0
    iput-wide v2, p0, Lokhttp3/internal/connection/c$b;->g:J
