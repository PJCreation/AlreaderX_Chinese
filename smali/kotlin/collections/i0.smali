...
.method public static i(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/i0;->j(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lkotlin/collections/h0;->d(Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/i0;->j(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lkotlin/collections/i0;->g(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final j(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 1
    invoke-static {p1, p0}, Lkotlin/collections/i0;->h(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static k(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    invoke-static {p0}, Lkotlin/collections/f0;->l(Ljava/util/Map;)Ljava/util/Map;
