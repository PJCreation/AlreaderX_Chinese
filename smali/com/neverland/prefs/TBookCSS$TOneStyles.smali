...
.method public getCSSString()Ljava/lang/String;
    ...
    iget-object v7, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->font:Lcom/neverland/prefs/TBookCSS$Style_Font;
    ...
    iget-object v7, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->size:Lcom/neverland/prefs/TBookCSS$Style_Size;
    ...
    .line 28
    sget-object v10, Lcom/neverland/prefs/TBookCSS$a;->c:[I

    iget-object v11, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->just:Lcom/neverland/prefs/TBookCSS$Style_Just;
    ...
    :cond_5
    const-string v10, "text-align:justify;"
    ...
    :cond_6
    const-string v10, "text-align:center;"
    ...
    :cond_7
    const-string v10, "text-align:right;"
    ...
    :cond_8
    const-string v10, "text-align:left;"
    ...
    iget-object v11, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->justlast:Lcom/neverland/prefs/TBookCSS$Style_Just;
    ...
    :cond_a
    const-string v10, "text-align-last:justify;"
    ...
    :cond_b
    const-string v10, "text-align-last:center;"
    ...
    :cond_c
    const-string v10, "text-align-last:right;"
    ...
    :cond_d
    const-string v10, "text-align-last:left;"
    ...
    .line 38
    sget-object v10, Lcom/neverland/prefs/TBookCSS$a;->d:[I

    iget-object v11, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->bold:Lcom/neverland/prefs/TBookCSS$Style_OnOff;
    ...
    :cond_f
    const-string v10, "font-weight:normal;"
    ...
    iget-object v11, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->italic:Lcom/neverland/prefs/TBookCSS$Style_OnOff;
    ...
    :cond_12
    const-string v10, "font-style:normal;"
    ...
    :cond_13
    const-string v10, "font-style:italic;"
    ...
    iget-object v11, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->razr:Lcom/neverland/prefs/TBookCSS$Style_OnOff;
    ...
    :cond_15
    const-string v10, "letter-spacing:normal;"
    ...
    :cond_16
    const-string v10, "letter-spacing:1;"
    ...
    iget-object v11, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->shadow:Lcom/neverland/prefs/TBookCSS$Style_OnOff;
    ...
    :cond_18
    const-string v10, "text-shadow:off;"
    ...
    :cond_19
    const-string v10, "text-shadow:on;"
    ...
    iget-object v11, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->hyph:Lcom/neverland/prefs/TBookCSS$Style_OnOff;
    ...
    .line 53
    sget-object v8, Lcom/neverland/prefs/TBookCSS$a;->e:[I

    iget-object v10, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->top:Lcom/neverland/prefs/TBookCSS$Style_MarginV;
    ...
    :pswitch_16
    const-string v8, "margin-top:4.0em;"
    ...
    :pswitch_17
    const-string v8, "margin-top:3.0em;"
    ...
    :pswitch_18
    const-string v8, "margin-top:2.0em;"
    ...
    :pswitch_19
    const-string v8, "margin-top:1.5em;"
    ...
    :pswitch_1a
    const-string v8, "margin-top:1.0em;"
    ...
    :pswitch_1b
    const-string v8, "margin-top:0.5em;"
    ...
    :pswitch_1c
    const-string v8, "margin-top:0.25em;"
    ...
    iget-object v8, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->bottom:Lcom/neverland/prefs/TBookCSS$Style_MarginV;
    ...
    iget-object v8, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->left:Lcom/neverland/prefs/TBookCSS$Style_MarginH;
    ...
    iget-object v8, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->right:Lcom/neverland/prefs/TBookCSS$Style_MarginH;
    ...
    iget-object v5, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->indent:Lcom/neverland/prefs/TBookCSS$Style_Indent;
    ...
    const-string v5, "reader-color:link;"

    const-string v8, "reader-color:firstletter;"

    const-string v10, "reader-color:text;"

    const-string v11, "reader-color:title;"

    if-eqz v1, :cond_23

    sget-object v1, Lcom/neverland/mainApp;->n:Lcom/neverland/utils/TCustomDevice;

    sget-object v12, Lcom/neverland/utils/TCustomDevice$IS_DEVICE;->standart:Lcom/neverland/utils/TCustomDevice$IS_DEVICE;

    invoke-virtual {v1, v12}, Lcom/neverland/utils/TCustomDevice;->isDevice(Lcom/neverland/utils/TCustomDevice$IS_DEVICE;)Z
    ...
    .line 149
    invoke-virtual {v1, v6}, Lcom/neverland/utils/TCustomDevice;->isDevice(Lcom/neverland/utils/TCustomDevice$IS_DEVICE;)Z

    move-result v6

    if-nez v6, :cond_24

    sget-object v6, Lcom/neverland/utils/TCustomDevice$IS_DEVICE;->usereink:Lcom/neverland/utils/TCustomDevice$IS_DEVICE;
    ...
    .line 151
    :cond_24
    iget v1, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->id:I
    ...
    iget-object v3, p0, Lcom/neverland/prefs/TBookCSS$TOneStyles;->color:Lcom/neverland/prefs/TBookCSS$Style_Color;
